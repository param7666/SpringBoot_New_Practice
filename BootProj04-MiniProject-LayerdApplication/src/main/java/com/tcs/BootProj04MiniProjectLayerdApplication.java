...
public class BootProj04MiniProjectLayerdApplication {
	...
	BootProj04MiniProjectLayerdApplication(EmpController empController) {
		this.empController = empController;
	}

	public static void main(String[] args) {
		ApplicationContext ctx =SpringApplication.run(BootProj04MiniProjectLayerdApplication.class, args);
